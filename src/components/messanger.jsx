...
function Main() {
    ...
    const chats = [
        ...
        { id: 3, name: "Иван Сидоров", lastMessage: "Отправил файл", unread: 1, online: false },
        { id: 4, name: "Екатерина Белова", lastMessage: "Спасибо за помощь!",  unread: 0, online: true },
        { id: 5, name: "Дмитрий Козлов", lastMessage: "Когда будет готово?", unread: 3, online: false }
    ];
